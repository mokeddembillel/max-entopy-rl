...
if __name__ == '__main__':
    ...
    parser.add_argument('--actor', type=str, default='svgd_p0_kernel_pram', choices=['sac', 'svgd_nonparam', 'svgd_p0_pram', 'svgd_p0_kernel_pram', 'diffusion'])
    ...
    parser.add_argument('--exploration_episodes', type=int, default=2) #S
    #parser.add_argument('--exploration_episodes', type=int, default=200)
    
    parser.add_argument('--num_test_episodes', type=int, default=2) #S
    #parser.add_argument('--num_test_episodes', type=int, default=10)
    
    parser.add_argument('--stats_episode_freq', type=int, default=5)

    parser.add_argument('--update_after', type=int, default=1000)
    #parser.add_argument('--update_after', type=int, default=50000) #B
    
    parser.add_argument('--update_every', type=int, default=50)
    #parser.add_argument('--update_every', type=int, default=500) #B
    
    #parser.add_argument('--max_ep_len', type=int, default=1000)
    parser.add_argument('--max_ep_len', type=int, default=100) #S
    ######optim 
