...
if __name__ == '__main__':
    ...
    # actor arguments
    if (args.actor in ['svgd_nonparam','svgd_p0_pram']):
    ...
    elif args.actor in ['svgd_p0_pram']:
    ...
    RL_kwargs = AttrDict(stats_steps_freq=args.stats_steps_freq,gamma=args.gamma,
        ...
        collect_stats_after=args.collect_stats_after, test_time=args.test_time, model_path=args.model_path, train_action_selection=args.train_action_selection)
    ...
    if not args.test_time:
        ...
        if args.actor not in ['svgd_nonparam', 'svgd_p0_pram']:
        ...
        if args.actor in ['svgd_nonparam', 'svgd_p0_pram', 'svgd_sql']:
