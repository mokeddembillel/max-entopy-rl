...
from networks import MLPFunction, CNNFunction
...
class ActorCritic(nn.Module):
    ...
    def forward(self, obs, action_selection=None, with_logprob=True, itr=None):
        return self.pi.act(obs, action_selection, with_logprob, itr)
