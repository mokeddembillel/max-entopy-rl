...
if __name__ == '__main__':
    ...
    parser.add_argument('--exploration_episodes', type=int, default=10000)
    ...
    # RL args
    RL_kwargs = AttrDict(num_episodes=args.num_episodes,steps_per_episode=args.steps_per_episode,gamma=args.gamma,alpha=args.alpha,replay_size=int(args.replay_size),exploration_episodes=args.exploration_episodes,update_after=args.update_after,
